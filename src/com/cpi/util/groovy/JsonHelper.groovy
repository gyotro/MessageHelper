...
class JsonHelper
{
    ...
    public static List<?> filterJson( Object jJSON, String sKey, String sVal ) throws Exception
    {
        ArrayList<?> sFilter = null;
        List<Map<?,?>> listAux = new ArrayList<>();
        JsonSlurper jsonParser = new JsonSlurper();
    ...
    public static List<?> advancedFilterJson_v2( Object jJSON, String sFilterIn) throws Exception
    {
